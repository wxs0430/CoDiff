...
def TESTACDC(iter=-1, phase='pre_train'):
    ...
    snapshot_path = "./model/CoDiff/ACDC_{}_{}_labeled/{}".format(FLAGS.exp, FLAGS.labelnum, FLAGS.stage_name)
    test_save_path = "./model/CoDiff/ACDC_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, FLAGS.labelnum, FLAGS.model)



    net1 = UNet_2d(in_chns=1, class_num=4).cuda()
    net2 = UNet_2d(in_chns=1, class_num=4).cuda()



    model_path1 = os.path.join(snapshot_path, 'best_model_1.pth')
    model_path2 = os.path.join(snapshot_path, 'best_model_2.pth')
