...
snapshot_path = "./model/CoDiff/LA_{}_{}_labeled/{}".format(FLAGS.exp, 8, FLAGS.stage_name)
test_save_path = "./model/CoDiff/LA_{}_{}_labeled/{}_predictions/".format(FLAGS.exp, 8, FLAGS.model)
num_classes = 2
...
def testLA():
    ...
    model_path1 = os.path.join("./model/CoDiff/LA_CoDiff_8_labeled/self_train", 'best_model_1.pth')
    model_path2 = os.path.join("./model/CoDiff/LA_CoDiff_8_labeled/self_train", 'best_model_2.pth')
